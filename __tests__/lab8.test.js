describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const text1 = await button.getProperty('innerText');
    await button.click();
    const text2 = await button.getProperty('innerText');
    
    let buttonChanged = false;
    if(text1['_remoteObject'].value != text2['_remoteObject'].value) {
      buttonChanged = true;
    }
